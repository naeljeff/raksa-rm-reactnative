...
var MainFUAPage = function MainFUAPage(_a) {
  var route = _a.route;
  var item = route.params.item;
  return react_1['default'].createElement(react_native_1.View, {
    className: 'w-full h-full flex flex-col bg-[#f7ebd7]'
  }, react_1['default'].createElement(HeaderIncomingFUA_1['default'], null), react_1['default'].createElement(react_native_1.ScrollView, {
  ...
  }), react_1['default'].createElement(IncomingCoorporateContact_1['default'], null), react_1['default'].createElement(IncomingFUA_1['default'], null)));
};
