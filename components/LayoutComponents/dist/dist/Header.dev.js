...
var Header = function Header(_a) {
  ...
  return react_1['default'].createElement(react_native_1.View, {
    className: 'w-full h-[45px] px-5 flex flex-row justify-between items-center bg-[#f5af46] '
  ...
  }, 'Logout')))), react_1['default'].createElement(react_native_1.Text, {
    className: 'text-lg text-black text-center font-semibold'
  }, 'RM'), react_1['default'].createElement(react_native_paper_1.Surface, {
    elevation: 3,
