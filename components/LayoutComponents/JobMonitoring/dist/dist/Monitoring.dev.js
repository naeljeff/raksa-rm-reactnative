...
var Monitoring = function Monitoring(_a) {
  var item = _a.item,
      index = _a.index;
  ...
  return react_1["default"].createElement(themed_1.ListItem.Accordion, {
    content: react_1["default"].createElement(themed_1.ListItem.Content, {
      className: "bg-[#f7ebd7]"
    }, react_1["default"].createElement(react_native_1.View, {
      className: "w-screen flex-row justify-between items-center py-6 pr-10 pl-6 border-b border-black bg-[#f7ebd7]"
    }, react_1["default"].createElement(react_native_1.Text, {
      className: "flex-[0.5] text-lg text-black font-semibold"
    }, item.nama), react_1["default"].createElement(react_native_1.View, {
      className: "flex-[0.5] flex-row justify-end items-center"
      ...
      onPress: function onPress() {
        return console.log("Pressed: " + item.nama);
      }
    }, react_1["default"].createElement(react_native_1.Text, {
      className: "text-xs text-black tracking-tighter"
    }, "To Do List"))), react_1["default"].createElement(react_native_1.View, {
      className: "flex-[0.3] flex items-center justify-center ml-2"
    }, react_1["default"].createElement(Ionicons_1["default"], {
      name: "mail",
      size: 24,
      color: "black"
    }), react_1["default"].createElement(react_native_paper_1.Badge, {
  ...
  }, testList.map(function (l, i) {
    return react_1["default"].createElement(react_native_1.View, {
      key: i
    }, react_1["default"].createElement(themed_1.ListItem, {
      containerStyle: {
        backgroundColor: 'rgba(255, 188, 60, 0.3)',
        paddingLeft: 0,
        paddingRight: 0
      }
    }, react_1["default"].createElement(themed_1.ListItem.Content, null, react_1["default"].createElement(MonitoringSubList_1["default"], {
      item: l
    }))), react_1["default"].createElement(react_native_1.View, {
      className: "w-screen border-b border-black"
    }));
  }));
};
