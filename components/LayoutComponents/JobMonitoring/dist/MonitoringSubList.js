...
var MonitoringSubList = function (_a) {
    ...
    return (react_1["default"].createElement(react_native_1.TouchableOpacity, { onPress: function () { return console.log(item.noPengajuanSurvey); }, className: "w-screen flex flex-row justify-start items-center" },
