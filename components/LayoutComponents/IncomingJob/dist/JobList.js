...
var JobList = function (_a) {
  ...
  var _c = react_1.useState(false),
    ...
    setLoadMore = _c[1];
  var pageSize = 10;
  var filterData = react_1.useMemo(
    function () {
      var filtered =
        searchByTerm === ''
          ...
          : data.filter(function (item) {
              return (
                typeof item[searchByTerm] === 'string' &&
                item[searchByTerm].toLowerCase().includes(search.toLowerCase())
              );
            });
      return filtered;
    },
  ...
  var sortedDataByDate = react_1.useMemo(
    function () {
  ...
  var paginatedData = react_1.useMemo(
    function () {
  ...
  var handleLoadMore = react_1.useCallback(
    function () {
  ...
  return react_1['default'].createElement(
    ...
    filterData.length === 0
      ...
      : react_1['default'].createElement(react_native_1.FlatList, {
          ...
          keyExtractor: getKey,
          refreshControl: react_1['default'].createElement(
