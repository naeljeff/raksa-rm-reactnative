...
var MySurveyList = function MySurveyList(_a) {
  var data = _a.data,
      search = _a.search,
  ...
  var renderItem = react_1.useCallback(function (_a) {
    var item = _a.item,
        index = _a.index;
    return react_1["default"].createElement(Survey_1["default"], {
      item: item,
      index: index,
  ...
  }, filterProcessedData.length === 0 ? react_1["default"].createElement(react_native_1.View, {
  ...
  }, "No Survey Found")) : react_1["default"].createElement(react_native_1.FlatList, {
    data: paginatedData,
