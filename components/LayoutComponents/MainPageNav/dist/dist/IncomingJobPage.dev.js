...
var IncomingJobPage = function IncomingJobPage() {
  ...
  var navigation = native_1.useNavigation(); // console.log(searchTerm);
  ...
  return react_1['default'].createElement(
    ...
    react_1['default'].createElement(SearchBarInput_1['default'], {
    ...
    refreshing && data.length === 0
      ? react_1['default'].createElement(
          ...
          {
            className:
              'w-full flex-1 bg-[#f7ebd7] inset-0 justify-center items-center',
          },
      ...
      : react_1['default'].createElement(JobList_1['default'], {
          data: data,
          search: searchTerm,
