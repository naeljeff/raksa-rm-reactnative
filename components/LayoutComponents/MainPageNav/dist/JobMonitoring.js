...
var MonitoringList_1 = require("../JobMonitoring/MonitoringList");
...
var JobMonitoring = function () {
    ...
    return (react_1["default"].createElement(react_native_1.View, { className: "flex flex-1 flex-col" },
        ...
        react_1["default"].createElement(MonitoringList_1["default"], { search: searchTerm, searchByTerm: searchByTerm, navigation: navigation, sortBy: sortBy, orderBy: orderBy })));
};
